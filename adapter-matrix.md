...
Every shipped adapter file in `agents/`, with its target path, install mode, and load class. v0.3.6 ships 9 primary adapters plus the `style-review` skill; 10 additional tool surfaces are on the v1.1 "Planned adapters" roadmap.

## Primary Adapters (v0.3.6, Shipped)
