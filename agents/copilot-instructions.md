...
<!-- Adapter: GitHub Copilot (repo-level custom instructions) -->
<!-- Target path: <repo root>/.github/copilot-instructions.md -->
<!-- Load class: single-file; install_mode: append-block -->

# agent-style v0.3.6 — GitHub Copilot repo-wide adapter
...
GitHub Copilot loads `.github/copilot-instructions.md` into every Copilot prompt for this repository. Copilot does not import from a second file; the compact directives below are what reach context for every Copilot request in this repo.
